...
def poll_result(poll_id):
	...
	return render_template('poll_result.html', poll=poll, poll_results=poll_results, count_op2=count_op2, count_op1=count_op1,percentage_op1=percentage_op1, responded=responded)
